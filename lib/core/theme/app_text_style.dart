...
class AppTextStyle {
  ...
  static TextStyle text18MSecond(BuildContext context, {bool listen = true, Color? color}) {
    return TextStyle(
      fontSize: 18.sp,
      fontWeight: FontWeight.w600,
      color: color ?? AppColor.secondAppColor(context, listen: listen),
  ...
  static TextStyle hint14boldStyle(BuildContext context, {bool listen = true, Color? color}) {
    return TextStyle(
      fontSize: 12.sp,
      fontWeight: FontWeight.w600,
      color: color ?? AppColor.greyColor(context, listen: listen),
