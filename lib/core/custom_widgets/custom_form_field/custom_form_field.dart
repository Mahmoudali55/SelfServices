    ...
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
              ...
              if (widget.title != null) ...{
                Expanded(
                  child: Text(
                    ...
                    style:
                        widget.titleStyle ??
                        AppTextStyle.formTitleStyle(context, color: AppColor.blackColor(context)),
                  ),
                ),
              },
          ...
          if (widget.title != null || widget.otherSideTitle != null) ...{const Gap(5)},
          Directionality(
            ...
            child: TextFormField(
              ...
              style:
                  widget.textStyle ??
                  AppTextStyle.textFormStyle(context, color: AppColor.blackColor(context)),
              ...
              decoration: InputDecoration(
                ...
                filled: true,
                border: _border(
                  color: widget.unFocusColor ?? AppColor.textFormBorderColor(context),
                ),
