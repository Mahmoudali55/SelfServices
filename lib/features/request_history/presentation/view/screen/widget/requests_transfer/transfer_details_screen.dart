      ...
      appBar: CustomAppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => PdfPrintUtils.printDetails(context, AppLocalKay.transfer.tr(), [
              PrintSection(
              ...
              PrintSection(
                ...
                items: {
                  ...
                  AppLocalKay.managerTo.tr(): isEn ? request.toDNameE : request.toDName,
                  AppLocalKay.departmentTo.tr(): isEn ? request.toBNameE : request.toBName,
                  AppLocalKay.projectTo.tr(): isEn ? request.toProjNameE : request.toProjName,
