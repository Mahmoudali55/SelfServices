...
class BackFromVacationDetailsScreen extends StatelessWidget {
  final GetRequestVacationBackModel request;

  const BackFromVacationDetailsScreen({super.key, required this.request});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(
        context,
        title: Text(AppLocalKay.backleave.tr(), style: AppTextStyle.text18MSecond(context)),
        centerTitle: true,
